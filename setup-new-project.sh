...
REPO_NAME="Nurse-Woyz-Aster"
DISPLAY_NAME="Nurse WOYZ"
...
git init -b main
git add .
git commit -m "Initial Nurse WOYZ application"

echo "Creating a brand-new GitHub repository..."
gh repo create "$REPO_NAME" "--$GITHUB_VISIBILITY" --source=. --remote=origin --description "Nurse WOYZ" --push
...
firebase apps:create WEB "Nurse WOYZ Web" --project "$PROJECT_ID" --json > "$temporary_dir/app.json"
...
echo
echo "NEW Nurse WOYZ resources created successfully."
